...
export class Simulation {
	...
	async waitForSimulationFinished() {
		const calc = this.editor
			.getSidebar("tools")
			.getByText("Calculating...", { exact: false });
